...
class FilterBadWords
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if ($hasBadWords) {
            return response()->json(['status' => 'Bạn vừa gửi lên review có chứa từ xấu. Xin hãy văn minh hơn!!!']);
        }
